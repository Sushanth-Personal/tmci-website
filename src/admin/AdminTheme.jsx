...
function applyThemeToDOM(vars) {
  ...
  root.style.setProperty("--cta", vars.cta || "#F59E0B");
  root.style.setProperty("--cta-hover", vars.ctaHover || "#D97706");
    ...
    if (data?.content) {
      try {
        ...
        const matchIndex = PRESETS.findIndex(
          (p) => p.vars.primary.toLowerCase() === vars.primary?.toLowerCase(),
        );
        if (matchIndex >= 0) setActivePreset(matchIndex);
        else setActivePreset(-1);
      } catch {}
    }
  }
  ...
  const colorFields = [
    {
      key: "primary",
      label: "Primary",
      desc: "Main brand colour — nav mark, links, accents, overlines",
    },
    {
      key: "primaryDk",
      label: "Primary Dark",
      desc: "Hover state of primary — darker shade",
    },
    {
      key: "primaryMd",
      label: "Primary Medium",
      desc: "Ticker background, eyebrow tags, CTA banner",
    },
    {
      key: "primaryLt",
      label: "Primary Light",
      desc: "Light text on dark backgrounds, eyebrow tags",
    },
    {
      key: "cta",
      label: "CTA Button",
      desc: "Primary call-to-action button — See Our Products, Get a Quote",
    },
    {
      key: "ctaHover",
      label: "CTA Button Hover",
      desc: "Hover state of the CTA button",
    },
    {
      key: "accent",
      label: "Accent",
      desc: "Star ratings, knob indicators, highlights",
    },
    {
      key: "accentLt",
      label: "Accent Light",
      desc: "Hover state of accent colour",
    },
  ];
    ...
    <div style={{ padding: 24, maxWidth: 900 }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ fontSize: 13, color: "#6B7280", marginTop: 4 }}>
          Change your entire website colour scheme. Changes apply live
          instantly.
        </p>
      </div>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {[
            ...
            { bg: theme.cta || "#F59E0B", label: "CTA Button" },
      ...
      >
        ...
        <p style={{ fontSize: 12, color: "#9CA3AF", marginBottom: 16 }}>
          Click any preset to apply instantly — then fine-tune below if needed.
        </p>
        <div
          style={{
            display: "grid",
          ...
          {PRESETS.map((preset, i) => (
            <button
              ...
              style={{
                ...
                border:
                  activePreset === i
                    ? `2px solid ${preset.vars.primary}`
                    : "1.5px solid #E5E7EB",
                background:
                  activePreset === i ? `${preset.vars.primary}0D` : "#F9FAFB",
      ...
      >
        ...
        <p style={{ fontSize: 12, color: "#9CA3AF", marginBottom: 20 }}>
          Fine-tune individual colours. Changes preview live immediately.
        </p>
        <div
          ...
          {colorFields.map(({ key, label, desc }) => (
            <div
              ...
              style={{
                ...
                padding: "12px 14px",
                border:
                  key === "cta" || key === "ctaHover"
                    ? "1px solid #FDE68A"
                    : "1px solid #F3F4F6",
                borderRadius: 8,
                background:
                  key === "cta" || key === "ctaHover" ? "#FFFBEB" : "#FAFAFA",
              }}
            >
      ...
      >
        ...
        <div style={{ fontSize: 12.5, color: "#92400E", lineHeight: 1.6 }}>
          <strong>Preview is live.</strong> Click <strong>Save Theme</strong> to
          make it permanent for all visitors.
        </div>
      </div>
